...
type User struct {
	...
	Phone           *string            `jason:"phone" validate:"required"`
	...
	UserCart        []ProductUser      `jason:"usercart" bson:"usercart"`
	Address_Details []Address          `jason:"address" bson:"address"`
...
type Order struct {
	Order_ID       primitive.ObjectID `json:"_id"`
