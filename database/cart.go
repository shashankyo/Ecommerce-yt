...
var (
	...
	ErrCantGetItem        = errors.New("eas unable to get the item from the cart")
...
func BuyItemFromCart(ctx context.Context, userCollection *mongo.Collection, userID string)error {
	//fetch the cart of thye use 
	//find the cart total
	//create an order with the items
	//added oredr to the nuser collection
	//added items in the cart to orsers
	//empty up the cart
	...
	_, err = userCollection.UpadteMany(ctx, filter, update)
	if err != nil {
		log.Println(err)
	}
...
func InstaBuyer(ctx context.Context, prodCollection, userCollection *mongo.Collection, productID primitive.ObjectID, UserID string ) error{
	id, err := primitive.ObjectIDFromHex(UserID)
